...
/* Проверяем, считает ли компилятор, что вы используете неправильную операционную систему. */
#if defined(__linux__)
#error "You are not using a cross-compiler, you will most certainly run into trouble"
#endif

/* Этот учебник будет работать только для 32-битных целевых платформ ix86. */
#if !defined(__i386__)
